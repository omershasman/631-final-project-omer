...
```
Below I am just doing Base R plot for Carrier Delays and no delay. Over the years the performance on on-time arrival has improved. But we cannot make too much with this data since it can be due to more flights added into the schedule. 
```{r}
